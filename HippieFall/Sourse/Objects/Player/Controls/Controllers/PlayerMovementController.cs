...
namespace HippieFall
{
    public class PlayerMovementController : Node, IEffectable
    {
        ...
        public SwipeControl SwipeControl { get; private set; }
        ...
        public void Init()
        {
            ...
            SwipeControl = HippieFallUtilities.Game.GameInterface.SwipeControl;
        ...
        {
            if (SwipeControl.Swiping)
            {
              
                    _move.x = SwipeControl.SwipePosition.x;
                    _move.z = SwipeControl.SwipePosition.y;
